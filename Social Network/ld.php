...
file_put_contents('likes.json', $string);
...
{
	$j1_ne[$value2]['0']['lik']=1;
	$j1_ne[$value2]['0']['disl']=0;
}
...
if($newArray_ne[$trav]==$value2)
{
	...
	if($j1[$value2]['0'][$ww]==$value1&&$loo%2==0&&$j1_ne[$value2]['0']['lik']!=0)
	{
	

	$j1_ne[$value2]['0']['lik']=$j1_ne[$value2]['0']['lik']-1;
